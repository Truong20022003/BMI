package com.example.bmi.Ui.YourHealthOld
...
import com.example.bmi.databinding.ActivityYourHealthBinding
import java.util.Locale

class YourHealthActivity : BaseActivity<ActivityYourHealthBinding, BaseViewModel>() {
    override fun createBinding() = ActivityYourHealthBinding.inflate(layoutInflater)
    override fun setViewModel() = BaseViewModel()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(binding.root)
        val intentBmi = intent.getFloatExtra("bmi", 0.0f)
        Log.d("bmikiddd", intentBmi.toString());
        val formattedBmi = String.format(Locale.US,"%.2f", intentBmi)
        binding.tvBmiIndex.setText(formattedBmi.toString())
        binding.bmiClock.setBMI(intentBmi)
        ...
        if (intentBmi < 18.5) {
            ...
            binding.cstUnderWeight.background =
                ContextCompat.getDrawable(this, R.drawable.custom_background_underweight)
        ...
        } else if (intentBmi >= 18.5 && intentBmi < 26.4) {
            ...
            binding.cstNormal.background =
                ContextCompat.getDrawable(this, R.drawable.custom_background_healthy)
        ...
        } else if (intentBmi >= 26.4 && intentBmi < 29.7) {
            ...
            binding.cstOverweight.background =
                ContextCompat.getDrawable(this, R.drawable.custom_background_overweight)
            ...
            binding.cstObese.background =
                ContextCompat.getDrawable(this, R.drawable.custom_background_obese)
